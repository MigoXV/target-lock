...
from target_lock.protos.lockon import gym_env_pb2 as target__lock_dot_protos_dot_lockon_dot_gym__env__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in target_lock/protos/lockon/gym_env_pb2_grpc.py depends on'
...
def add_ArmEnvServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamEnv': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamEnv,
                    request_deserializer=target__lock_dot_protos_dot_lockon_dot_gym__env__pb2.EnvRequest.FromString,
                    response_serializer=target__lock_dot_protos_dot_lockon_dot_gym__env__pb2.EnvReply.SerializeToString,
            ),
    }
